        ...
        [
            mo.md(
                ...
                **Evidence first:** all six scoped machine contracts pass, but a
                ...
                official score is 5/12; these outcomes are now published at
                `adc03f7d` and await the live judge. No score increase is claimed.
                """
            ),
            _fig,
        ]
...
def _(mo):
    mo.md(
        ...
        to the first release; revision `adc03f7d` has been published but has
        not received a new verdict. These exact Gaussian specializations test the theorem factors,
